-- Allow admin to create up to 10 accounts (was 8)
...
BEGIN
  ...
  IF (SELECT count(*) FROM public.profiles) >= 10 THEN RAISE EXCEPTION 'Account limit reached: maximum 10 accounts'; END IF;
