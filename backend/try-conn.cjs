...
const variants = [
  ['postgres.<ref>', `postgresql://postgres.${ref}:${encodeURIComponent('bTbCr8nKO0qiVhCG')}@${host}:6543/postgres`],
  ['postgres (no ref)', `postgresql://postgres:${encodeURIComponent('bTbCr8nKO0qiVhCG')}@${host}:6543/postgres`]
];
(async () => {
